...
func main() {
	...
	//println(dp.NumDecodings("12"))
	//println(dp.NumDecodings("226"))
	//println(dp.NumDecodings("0"))
	//println(dp.NumDecodings("06"))
	//println(dp.NumDecodings("2101"))
	//println(dp.NumDecodings("17"))
